...
proc create_root_design { parentCell } {
  ...
  set douta_0 [ create_bd_port -dir O -from 7 -to 0 douta_0 ]
  ...
  connect_bd_net -net CLK [get_bd_ports CLK] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins c_counter_binary_0/CLK]
